...
1. **System Requirements:**
	...
	```
		...
		Return: {an array of account credential information, account numbers, passwords, and answers to personal challenge questions, like 
	```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODAxNDU2NDc1LDQ2ODAzMTc4MF19
-->