...
1. **System Requirements:**
	...
	```
		...
		Return: {an array of account credential information, account numbers, passwords, and answers to personal challenge questions, like your fav
	```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0NzA1Njc3Nyw4MDE0NTY0NzVdfQ==
-->