...
1. **System Requirements:**
	...
	```
		...
		Return: {an array of account credential information, account numbers, passwords, and answers to personal challenge questions
	```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjM4NzE2ODQsLTEwMjkyODUxOTQsLT
IxMDI5OTc0MDUsNDIyOTI3NDk3LC03MjkxMzk4NjIsLTE0NTY5
ODIwNl19
-->